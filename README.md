...
Two scanners out of seventy flag `MasterLooter.asi` on 1.6.25. Webroot calls it `Win.Hacktool.Gen`, its generic name for anything shaped like a trainer, and has since 1.6.5. Microsoft is back with its `Trojan:Win32/Wacatac.C!ml` guess after five quiet releases, as it was for 1.6.18 and 1.6.19; the `!ml` is a model reporting the shape of a file rather than a match on anything. Symantec and Cynet stopped at the first signed build and have not come back. Webroot alone objects to the archives, one of sixty-eight, for the same file inside them.

The number moves release to release without the code changing character: 1.2.1 scored four, 1.4.0 four, 1.5.0 two, 1.5.1 four, 1.6.0 two, 1.6.1 three, 1.6.2 three, 1.6.3 three, 1.6.4 four, 1.6.5 four, 1.6.6 four, 1.6.7 three, 1.6.8 four, 1.6.9 four, 1.6.10, the first signed build, two, 1.6.12 one, 1.6.13 one, 1.6.14 one, 1.6.15 two, 1.6.16 two, 1.6.17 one, 1.6.18 two, 1.6.19 two, 1.6.20 one, 1.6.21 one, 1.6.22 one, 1.6.23 one, 1.6.24 one and 1.6.25 two. Microsoft flagged every one of them up to the signature, went quiet for five releases, came back for two, dropped off for five more and is back on 1.6.25; Symantec flagged every unsigned build and none since. Everything else comes and goes: Deep Instinct has left, CrowdStrike Falcon stayed three releases and dropped off on 1.6.6, Cynet appeared on 1.6.4, was gone by 1.6.5, came back on 1.6.6, left on 1.6.7, returned on 1.6.9 and left again with the signature, Webroot arrived on 1.6.5, a build whose one change is that it no longer creates a Direct3D device at startup, and Elastic arrived on 1.6.8 and was gone again on 1.6.9. That is what a model guessing looks like, as against a scanner recognising something.

Reports for 1.6.25: [the plugin](https://www.virustotal.com/gui/file/cf98f6b1da2f215593a7e3010ff1745700314ffcc61f32d8862b9821cc6ecc78) and [the package](https://www.virustotal.com/gui/file/961cc7439bc98a7c22cbe8d968e66534f0afb3c444d125825f15c63530484c41).
...
If Defender or your browser quarantines the download, restore it and exclude the game's `bin64` folder, or build from source and use your own binary. SHA-256 for 1.6.25:

    961cc7439bc98a7c22cbe8d968e66534f0afb3c444d125825f15c63530484c41  MasterLooter-1.6.25-DMM.zip
    fb8b27a56ed36146109c45ea005b20c0936ac3f83e5ee5d4fb8d627e61dc9bef  MasterLooter-1.6.25.zip
    cf98f6b1da2f215593a7e3010ff1745700314ffcc61f32d8862b9821cc6ecc78  MasterLooter.asi
