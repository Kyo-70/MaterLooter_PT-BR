...
One scanner out of seventy flags `MasterLooter.asi` on 1.6.23. Webroot calls it `Win.Hacktool.Gen`, its generic name for anything shaped like a trainer, and has since 1.6.5. Microsoft came back for 1.6.18 and 1.6.19 with its `Trojan:Win32/Wacatac.C!ml` guess and has been away for four releases since; the `!ml` is a model reporting the shape of a file rather than a match on anything. Symantec and Cynet stopped at the first signed build and have not come back. Webroot alone objects to the archives, one of sixty-one, for the same file inside them.

The number moves release to release without the code changing character: 1.2.1 scored four, 1.4.0 four, 1.5.0 two, 1.5.1 four, 1.6.0 two, 1.6.1 three, 1.6.2 three, 1.6.3 three, 1.6.4 four, 1.6.5 four, 1.6.6 four, 1.6.7 three, 1.6.8 four, 1.6.9 four, 1.6.10, the first signed build, two, 1.6.12 one, 1.6.13 one, 1.6.14 one, 1.6.15 two, 1.6.16 two, 1.6.17 one, 1.6.18 two, 1.6.19 two, 1.6.20 one, 1.6.21 one, 1.6.22 one and 1.6.23 one. Microsoft flagged every one of them up to the signature, went quiet for five releases, came back for two and has dropped off again; Symantec flagged every unsigned build and none since. Everything else comes and goes: Deep Instinct has left, CrowdStrike Falcon stayed three releases and dropped off on 1.6.6, Cynet appeared on 1.6.4, was gone by 1.6.5, came back on 1.6.6, left on 1.6.7, returned on 1.6.9 and left again with the signature, Webroot arrived on 1.6.5, a build whose one change is that it no longer creates a Direct3D device at startup, and Elastic arrived on 1.6.8 and was gone again on 1.6.9. That is what a model guessing looks like, as against a scanner recognising something.

Reports for 1.6.23: [the plugin](https://www.virustotal.com/gui/file/0d59efad9f0f64350451fc762aaea3796a37a13f86171e3220c9a5bd53fe946d) and [the package](https://www.virustotal.com/gui/file/2c95a6c25d0b8a16782ade63df75538f9dc220695aa0fec2a87c3fbfc9d47094).
