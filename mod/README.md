...
- Gather nodes are identified by their prefab, matched against a table of 1,998 node kinds built from the game's own data. A node outside that table is identified by what lands in your bag when it is gathered, and is otherwise left alone until you turn Unidentified nodes on.
